<div class="modal fade modal-base-form" id="modal_buy" tabindex="-1" role="dialog" aria-labelledby="exampleBuy" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h3 class="modal-title text-center w-100" id="exampleBuy">
                    Заявка на покупку
            ...
            <div class="modal-body">
                <form id="modal_buy_form" class="ajax_form">
                    {{ csrf_field() }}
                    ...
                    <div class="form__input input">
                        <label class="input__title">Количество (шт.)</label>
                        <input type="text" class="input__wrap" name="count" placeholder="∞">
                    </div>
                    <div class="form__input input">
                    ...
                    <div onclick="sendOrder('modal_buy')"
                         class="form__btn btn btn_bg-red">Отправить</div>
                </form>
            </div>

            <div class="modal-footer">
                <div id="result_send_order_modal_buy" class="w-100 text-center order-message">* все поля обязательны для заполнения</div>

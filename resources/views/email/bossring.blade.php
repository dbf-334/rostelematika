...
@section('mail_title')
    <h1 style="margin: 0;">У клиента возник вопрос/жалоба/предложение к руководству</h1>
@endsection
        ...
        <tr>
            <td style="padding: 30px 0;">
                <p>
                    ...
                    Текст сообщения: <span style="font-weight: bold; color: #2a7298;">{{request()->comment}}</span>.
                </p>
                <p>

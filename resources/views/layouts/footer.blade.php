            ...
            <div class="footer__content">
                ...
                <div class="footer__feedback feedback">
                    ...
                    <div class="feedback__btns row i-mid">
                        ...
                        <!--a data-fancybox="" data-src="#popup-callback" href="javascript:;"
                           class="feedback__callback btn btn_bg-red btn_border-red btn_italic btn_small">Вам перезвонить?</a-->

                        <div class="feedback__messagers messagers">
                            <ul class="no__list">
                                <li>
                                ...
                                <li>
                                    <a href="https://api.whatsapp.com/send?phone={{ app('global')['whatsapp_phone'] }}">
    ...
    <div class="footer__foot">
        <div class="container row">
            <div class="footer__desc">
                ...
                <a data-fancybox="" data-src="#popup-policy" href="javascript:;">Политика обработки персональных данных</a>
            </div>

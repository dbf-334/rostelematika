...
@section('content')
    <div class="page-guarantees">
        ...
        <div class="container pb-4">
            ...
            <p>Обратившись в нашу компанию за установкой системы мониторинга, Вы получаете пожизненную гарантию на оборудование.</p>
            <p>При этом всем, мы гарантируем, что наши устройства и дополнительные элементы будут работать максимально исправно.</p>
        </div>

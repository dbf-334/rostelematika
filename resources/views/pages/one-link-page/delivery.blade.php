...
@section('content')
    <div class="page-delivery">
        ...
        <div class="container pb-4">
            ...
            <p>Вы оплатили счет на установку системы мониторинга?</p>
            <p>Вам осталось дождаться, пока наши специалисты приедут к Вам в течение 3-х дней.</p>
            <p>При этом всем, процесс установки 1 прибора ГЛОНАСС занимает всего лишь 30 минут.</p>
            <p>Мы сделаем это профессионально, быстро, так как в нашей компании работают сертифицированные мастера.</p>
        </div>

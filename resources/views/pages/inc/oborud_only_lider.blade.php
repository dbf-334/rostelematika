...
{{-- Показываем только лидеров продаж в выбраной категории товаров --}}
{{-- Пример вызова блока @include('pages.inc.oborud_only_lider',[ 'type'=>'Курсоуказатель', 'count'=>2 ]) --}}
...
<div class="oborudovanie container pb-5">
    <div class="row h-auto">
        ...
        @foreach(DB::table('equipment')->where('type','=',$type)->where('lider','<>','0')->orderBy('lider', 'desc')->
                orderBy('id', 'desc')->take($count)->get() as $item)

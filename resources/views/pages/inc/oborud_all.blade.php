...
<div class="oborudovanie container pb-5">
    ...
    <p class="pt-5">Продажа, установка и обслуживание оборудования <strong>"{{$type}}"</strong> осуществляется на всей
        территории {{$domain->postfix2}} и во многих других городах.</p>
</div>

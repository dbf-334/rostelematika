//--------------------------------------------------------------------------
// Анимация круга / Стили / Разматка на странице
//--------------------------------------------------------------------------
/*
    <div class="circle-container">
        <div class="circlestat" data-dimension="100" data-text="70" data-width="10" data-fontsize="28"
             data-percent="70" data-fgcolor="#01aef2" data-bgcolor="#eee" data-fill="#ddd"></div>
    </div>
...
//*** скрипт круговой анимации для блоков ***//
(function(a){
    a.fn.circliful=function(b,d){
        var c=a.extend({fgcolor:"#556b2f",bgcolor:"#eee",fill:false,width:15,dimension:200,fontsize:15,percent:50,
            animationstep:1,iconsize:"20px",iconcolor:"#999",border:"default",complete:null},b);
        return this.each(function(){
            var w=["fgcolor","bgcolor","fill","width","dimension","fontsize","animationstep","endPercent","icon",
                "iconcolor","iconsize","border"];
            var f={};
            var F="";
            var n=0;
            var t=a(this);
            ...
            function m(x){
                ...
                if(o==n&&k&&typeof(b)!="undefined"){if(a.isFunction(b.complete)){b.complete();k=false}}
            }
